...
export default function Aboutsectiontailwind() {
    return (
        <section className="w-full flex flex-col md:flex-row items-center min-h-[200px] md:min-h-[450px] h-auto bg-[#05050511] border-b border-[#cccccc2d] px-[5%] py-[20px]">
            ...
            <div className="flex flex-col ml-0 mt-[20px] md:ml-[180px] md:mt-0">
                <h2 className="text-sm md:text-4xl font-bold text-[#f7f7f7] mt-[10px]">About Me</h2>
                <p className="text-sm md:text-2xl font-normal text-[#f7f7f7] max-w-[800px] mt-[15px] md:mt-[35px]">Hi, I'm Bruno! I'm a passionate developer with experience in creating engaging web applications.</p>
                    <div className="mt-[20px] md:mt-[50px] flex items-center">
